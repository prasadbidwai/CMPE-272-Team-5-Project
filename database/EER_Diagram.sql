...
-- -----------------------------------------------------
-- Table `AnimalDynamicsNew`.`Animal_Type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AnimalDynamicsNew`.`Animal_Type` (
  `vertebrates_id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`vertebrates_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 6
...
-- -----------------------------------------------------
-- Table `AnimalDynamicsNew`.`ThreatStatus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AnimalDynamicsNew`.`ThreatStatus` (
